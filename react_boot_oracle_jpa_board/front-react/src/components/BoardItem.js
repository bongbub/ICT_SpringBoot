...
const BoardItem = (props) => {
    ...
    const { b_num, b_title, b_content, b_password, b_writer, b_read_cnt, b_reg_date, b_comment_count } = props.board;     // 구조분해할당
        ...
        <div>
            <Card>
                <Card.Body>
                    ...
                    <Card.Title>조회수 : {b_read_cnt}</Card.Title>
                    <Card.Title>작성일 : {b_reg_date}</Card.Title>
